...
public class HomeProductListAdapter extends ProductListAdapter {
    protected static final String TAG = "HOME_PLA";

    public HomeProductListAdapter(Activity activity, ArrayList<Product> products) {
